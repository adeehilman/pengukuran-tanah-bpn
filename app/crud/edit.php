                   ...
                   <!-- phone mask -->
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        data-inputmask="'mask': ['9999-999-9999 [99999]']" data-mask placeholder="Masukkan No. Hp Anda" value="<?php echo $view['no_telp'];?>" name="nope">
                      </div>
                    </div>
                    <!-- /.form group -->  
                  <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <label for="exampleInputEmail1" >Status</label> <br>
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-secondary hidden">
                        <input type="radio" name="status" id="option_a1" value="off">
                      </label>
                   ...
                   <div class="form-group">
                    ...
                    <input type="adress" class="form-control" value="0" id="exampleInputAdress" placeholder="Automatic" name="petugas" hidden>
                  </div>
